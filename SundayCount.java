 ...
 * 
 * So every time when the months starts he counts the number of sundays he will
 * get to enjoy. Considering the month can start with any day, be it Sunday,
 * Monday…. Or so on.
 * 
 ...
 * Explanation:
 * 
 * The month start with mon(Monday). So the upcoming sunday will arrive in next
 * 6 days. And then next Sunday in next 7 days and so on.
 * 
